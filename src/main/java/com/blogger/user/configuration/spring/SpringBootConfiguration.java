package com.blogger.user.configuration.spring;
...
@ComponentScan(basePackages = { "com.blogger.user" })
@EntityScan(basePackages = { "com.blogger.user.document" })
@EnableMongoRepositories(basePackages = { "com.blogger.user.repository" })
