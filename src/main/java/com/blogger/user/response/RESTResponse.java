package com.blogger.user.response;
...
import com.blogger.user.configuration.listener.ApplicationContextListener;
import com.blogger.user.constant.UserConstants;
import com.blogger.user.util.AppProperties;
import com.blogger.user.util.AppUtil;
import com.blogger.user.util.ResourceBundleUtil;
...
public class RESTResponse {
    ...
    public static RESTResponse ok(final Object data, final String infoMsg) {
        return new RESTResponse(data,
                status(UserConstants.SUCCESS_CODE, getInfoMessage(infoMsg)));
    }
    ...
    public static RESTResponse ok(final Object data) {
        ...
        && AppUtil.isEmpty((Collection<?>) data)) {
            return new RESTResponse(status(UserConstants.SUCCESS_CODE,
                    getInfoMessage(UserConstants.RECORDS_NOT_FOUND)));
        } else {
        ...
        return new RESTResponse(data, status(UserConstants.SUCCESS_CODE,
                getInfoMessage(UserConstants.SUCCESS)));
    }
    ...
    private static String getInfoMessage(final String infoMsg) {
        ...
        return ResourceBundleUtil.getLocalizedMessage(
                "com/blogger/module/user/messages/info/info", infoMsg,
